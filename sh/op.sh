...
cp -rf --parents target/linux package/kernel package/boot package/network/config/wifi-scripts package/firmware include/kernel* config/Config-images.in config/Config-kernel.in include/image*.mk include/trusted-firmware-a.mk scripts/ubinize-image.sh package/utils/bcm27xx-utils package/devel/perf ../
cd ..
...
sed -i '47,48d' feeds/dns/luci-app-mosdns/luasrc/model/cbi/mosdns/basic.lua
